...
export default class TicketGenerator {
  ...
  constructor() {
    ...
    this._winning_ids = {
      'abc123': [{"id":"beer2","sound":"klipp_och_klistra"},{"id":"beer2","sound":"klipp_och_klistra"},{"id":"beer3","sound":"random"},{"id":"burger","sound":"hamburgare_eller_baguette"},{"id":"beer","sound":"random"},{"id":"beer","sound":"random"},{"id":"vip","sound":"vinner_ingenting"},{"id":"beer","sound":"random"},{"id":"beer3","sound":"random"},{"id":"multiply2","sound":"anton_skratt"}],
      'def456': [{"id":"burger","sound":"hamburgare_eller_baguette"},{"id":"beer2","sound":"klipp_och_klistra"},{"id":"beer","sound":"random"},{"id":"beer2","sound":"klipp_och_klistra"},{"id":"beer2","sound":"klipp_och_klistra"},{"id":"beer3","sound":"random"},{"id":"beer","sound":"random"},{"id":"beer3","sound":"random"},{"id":"vip","sound":"vinner_ingenting"},{"id":"multiply5","sound":"anton_skratt"}],
